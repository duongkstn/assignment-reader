...
def _mobilenet_v3_conf(arch: str, width_mult: float = 1.0, reduced_tail: bool = False, dilated: bool = False,
    ...
    if arch == "mobilenet_v3_large":
        inverted_residual_setting = [
            ...
            bneck_conf(24, 5, 72, 40, True, "RE", (2, 1), 1),  # C2
            ...
            bneck_conf(112, 5, 672, 160 // reduce_divider, True, "HS", (2, 1), dilation),  # C4
...
if __name__ == '__main__':
    print(mobilenet_v3_large().features.forward(torch.zeros((1, 3, 32, 224))).shape)
    print(mobilenet_v3_small().features.forward(torch.zeros((1, 3, 32, 224))).shape)
